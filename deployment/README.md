...
For a later release that changes only `app/web/**`, public Streamlit
configuration, `VERSION`, or non-runtime release evidence under `tests/**`,
`docs/**`, `CHANGELOG.md`, `CURRENT_STATE.md` and `README.md`, the operator may
explicitly set
