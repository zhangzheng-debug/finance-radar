...
> 历史交接说明：本文件记录 2026-08-20 的初始骨架设计。价格模块随后已经完成
> `market-anchor-v1` / `market-windows-v2` 实装；当前权威合同与运行方式见
> `docs/EVENT_TAXONOMY_AND_MARKET_ANCHOR_V1.md`。下文关于“当前仍以 first_capture
> 为锚”及“待增加锚点字段”的内容仅用于说明旧缺陷，不代表现状。
