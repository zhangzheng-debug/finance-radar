...
DEFAULT_CRITICAL_FILES: tuple[str, ...] = (
    ...
    "app/services/deepseek_capture_interpretation.py",
    "app/services/event_admission.py",
    "app/services/financial_knowledge.py",
    "app/services/historical_primary_readmission.py",
    "app/services/source_observation_recovery.py",
    ...
    "deployment/systemd/finance-radar-market.service",
    "deployment/systemd/finance-radar-market.timer",
    "deployment/systemd/finance-radar-capture-interpretation.service",
    "deployment/systemd/finance-radar-capture-interpretation.timer",
    ...
    "scripts/run_market_cycle.py",
    "scripts/run_capture_interpretation_deepseek.py",
    "scripts/run_capture_interpretation_worker.py",
    "scripts/prepare_human_gold_router_inputs.py",
    "scripts/train_risk_router_human_gold.py",
